...
namespace Kudu.Core.Helpers
{
    public static class PostDeploymentHelper
    {
        ...
        private static TimeSpan GetCommandTimeOut()
        {
            ...
            var val = System.Environment.GetEnvironmentVariable("SCM_COMMAND_IDLE_TIMEOUT");
        ...
        private static IEnumerable<string> GetPostBuildActionScripts()
        {
            ...
            var postDeploymentPath = System.Environment.GetEnvironmentVariable("SCM_POST_DEPLOYMENT_ACTIONS_PATH");
